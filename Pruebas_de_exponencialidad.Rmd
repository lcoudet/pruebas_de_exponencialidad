...
Un experimento en Florida (EEUU) diseñado para estudiar el efecto de la aplicación de dosis de metilmercurio (un veneno) en el tiempo de vida de los peces.
...
$$ H_0: r(x)=\lambda $$
La hipótesis nula de exponencialidad implica suponer una \textbf{tasa constante}, es decir \textbf{\underline{independiente de la edad}}, el cual es el supuesto de la distribución exponencial. A veces se dice que la distribución exponencial \textit{no tiene memoria}, lo cual se debe a lo anterior.
...
$$S_i = \sum_{u=1}^n D_u \, \, \, \, \, i=1, \ldots, n$$
...
# Methylmercury poisoning: One sided test contra alternativa IFR
